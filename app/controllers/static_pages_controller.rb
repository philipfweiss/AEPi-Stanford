class StaticPagesController < ApplicationController
  ...
  def current
    ...
    michael_s_bio = "Michael Spelfogel pretends he doesn’t actually work for Uber, but nobody’s buying it. An MS&E major with a knack for hacking into the most widely used iPhone applications, Michael is a very accomplished young man. He is classy as all hell and would never miss an opportunity to whip out that tux. He speaks between one and four languages fluently. Ask him about casual trips to Iceland. Because he does that."
