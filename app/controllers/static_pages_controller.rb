class StaticPagesController < ApplicationController
  ...
  def current
    ...
    @brothers = {
        ...
        "Matthew Wigler" => {:bio => matthew_w_bio, :image => 'brothers/matthew_w.jpg', :year => "'19"},
      ...
      #  "Philip Clark" => {:bio => philip_c_bio, :image => 'brothers/philip_c.jpg', :year => "'19"},
       "Philip Weiss" => {:bio => philip_w_bio, :image => 'brothers/philip_w.jpg', :year => "'19"},
       ...
       "Aaron Marks" => { :leadership => true, :bio => aaron_m_bio, :image => 'brothers/aaron_m.png', :year => "'20", :title => 'Vice President'},
       "Cade May" => {:bio => cade_m_bio, :image => 'brothers/cade_m.png', :year => "'19"},
        "Daniel Alvarado" => {:bio => daniel_a_bio ,:image => 'brothers/daniel_a.png', :year => "'20"},
      ...
      # "Shawn Ahdout" => {:bio => shawn_a_bio, :image => 'brothers/shawn_a.png', :year => "'20"},
        ...
        "Ryan Kalili" => {:bio => ryan_k_bio, :image => 'brothers/ryan_k.png', :year => "'20"},
        "Max Minshull" => {:bio => max_m_bio, :image => 'brothers/max_m.png', :year => "'20"},
      #   "Max Arsenault" => {:bio => max_a_bio, :image => 'brothers/max_a.png', :year => "'19"},
        "Sam Lurye" => { :leadership => true, :bio => sam_l_bio, :image => 'brothers/sam_l.png', :year => "'20", :title => 'President'},
